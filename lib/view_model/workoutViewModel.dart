...
class WorkoutViewModel implements WorkoutInterface {
  ...
  Future getExercises(String trainerID, String weekID, String workoutID,
      String seriesID, Source source) async {
  ...
  @override
  Future getSeries(
      String trainerID, String weekID, String workoutID, Source source) async {
    var firestore = Firestore.instance;
    QuerySnapshot qn = await firestore
        .collection('Trainers')
  ...
  @override
  String getUserHistoryNotes(
      List<dynamic> notesList, String userId, String time) {
    String note = '';
    for (int i = 0; i < notesList.length; i++) {
      String item = notesList[i];
