...
Widget timeType(
  ...
  return MediaQuery.of(context).orientation == Orientation.portrait
      ? Container(
          margin: EdgeInsets.only(bottom: SizeConfig.blockSizeVertical * 0),
          child: Column(
            ...
            children: <Widget>[
                          ...
                          Container(
                            ...
                            child: FlatButton(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    color:
                                        MyColors().lightBlack.withOpacity(0.5)),
                              ),
                            ),
                          ),
                        ],
              ...
              Align(
                // heightFactor: SizeConfig.blockSizeVertical * 10,
